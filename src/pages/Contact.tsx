      ...
      <section className="pt-32 sm:pt-40 pb-16 sm:pb-20">
        <div className="container px-6 sm:px-8 lg:px-12">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              Let's Discuss <span className="text-gradient-gold">Opportunities</span>
            </motion.h1>
            <motion.p
            ...
            >
              ...
              requiring property solutions, I'm here to help.
            </motion.p>
          </div>
        </div>
      </section>
            ...
            <div className="grid lg:grid-cols-5 gap-12 lg:gap-16">
              ...
              >
                ...
                <motion.div
                  ...
                  className="p-6 bg-gradient-to-br from-secondary/30 to-secondary/10 rounded-2xl border border-border"
                >
                  <p className="text-xs uppercase tracking-wider text-muted-foreground mb-3">
                    Legacy Contact • BBM PIN
                  </p>
                  <code className="text-3xl font-display text-primary">2b134bb2</code>
                  <p className="text-sm text-muted-foreground mt-3">
                    A testament to over a decade of consistent presence in the Nigerian business landscape.
                  </p>
                </motion.div>
              </motion.div>
